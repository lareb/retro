...
class FeesControllerTest < ActionController::TestCase
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post :create, fee: { description: @fee.description, display_name: @fee.display_name, name: @fee.name }
    end
  ...
  test "should update fee" do
    put :update, id: @fee, fee: { description: @fee.description, display_name: @fee.display_name, name: @fee.name }
    assert_redirected_to fee_path(assigns(:fee))
  end
